...
# Ruff rule ISC001 (flake8-implicit-str-concat): single line implicit string concatenation
# Clean-room Rego implementation for the Vulnetix CLI input model.

package vulnetix.rules.ruff_isc001
...
metadata := {
	...
	"help_uri": "https://docs.astral.sh/ruff/rules/single-line-implicit-string-concatenation/",
	"languages": ["python"],
	"severity": "low",
	"level": "warning",
	"kind": "sast",
	...
	"ruff_name": "single-line-implicit-string-concatenation",
	"ruff_since": "v0.0.201",
	"ruff_fix": "Sometimes",
}
